...
//=====================================================================================================================//
    if ($bolsa_ampi == '') {
      ...
      $sqls = 'UPDATE campana SET otros="'.$otros.'",web="'.$web.'",web_fecha="'.$web_fecha.'",letrero="'.$letrero.'",letrero_fecha="'.$letrero_fecha.'",redes_sociales="'.$redes_sociales.'",redes_fecha="'.$redes_fecha.'",evento_open_house="'.$evento_open_house.'",evento_fecha="'.$evento_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sql3 = 'UPDATE campana SET bolsa_btn="'.$bolsa_btn.'",portal_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      ...
      $sql = 'UPDATE campana SET bolsa_ampi="'.$bolsa_ampi.'",bolsa_fecha="'.$bolsa_fecha.'",portal_crm="'.$portal_crm.'",portal_fecha="'.$portal_fecha.'",portal_crm="'.$portal_crm.'",portal_fecha="'.$portal_fecha.'",revista="'.$revista.'",revista_fecha="'.$revista_fecha.'",venta_brokers="'.$venta_brokers.'",venta_fecha="'.$venta_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sqls = 'UPDATE campana SET otros="'.$otros.'",periodico="'.$periodico.'",periodico_fecha="'.$periodico_fecha.'",letrero="'.$letrero.'",letrero_fecha="'.$letrero_fecha.'",redes_sociales="'.$redes_sociales.'",redes_fecha="'.$redes_fecha.'",evento_open_house="'.$evento_open_house.'",evento_fecha="'.$evento_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sql3 = 'UPDATE campana SET bolsa_btn="'.$bolsa_btn.'",portal_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $rutas = $conexion->query($sqls);
      $ruta3 = $conexion->query($sql3);
      if ($ruta = $conexion->query($sql)) {
      ...
      $sql = 'UPDATE campana SET bolsa_ampi="'.$bolsa_ampi.'",bolsa_fecha="'.$bolsa_fecha.'",portal_crm="'.$portal_crm.'",portal_fecha="'.$portal_fecha.'",portal_crm="'.$portal_crm.'",portal_fecha="'.$portal_fecha.'",revista="'.$revista.'",revista_fecha="'.$revista_fecha.'",venta_brokers="'.$venta_brokers.'",venta_fecha="'.$venta_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sqls = 'UPDATE campana SET otros="'.$otros.'",periodico="'.$periodico.'",periodico_fecha="'.$periodico_fecha.'",web="'.$web.'",web_fecha="'.$web_fecha.'",redes_sociales="'.$redes_sociales.'",redes_fecha="'.$redes_fecha.'",evento_open_house="'.$evento_open_house.'",evento_fecha="'.$evento_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sql3 = 'UPDATE campana SET bolsa_btn="'.$bolsa_btn.'",portal_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $rutas = $conexion->query($sqls);
      $ruta3 = $conexion->query($sql3);
      if ($ruta = $conexion->query($sql)) {
      ...
      $sql = 'UPDATE campana SET bolsa_ampi="'.$bolsa_ampi.'",bolsa_fecha="'.$bolsa_fecha.'",portal_crm="'.$portal_crm.'",portal_fecha="'.$portal_fecha.'",portal_crm="'.$portal_crm.'",portal_fecha="'.$portal_fecha.'",revista="'.$revista.'",revista_fecha="'.$revista_fecha.'",venta_brokers="'.$venta_brokers.'",venta_fecha="'.$venta_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sqls = 'UPDATE campana SET otros="'.$otros.'",periodico="'.$periodico.'",periodico_fecha="'.$periodico_fecha.'",web="'.$web.'",web_fecha="'.$web_fecha.'",letrero="'.$letrero.'",letrero_fecha="'.$letrero_fecha.'",evento_open_house="'.$evento_open_house.'",evento_fecha="'.$evento_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sql3 = 'UPDATE campana SET bolsa_btn="'.$bolsa_btn.'",portal_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $rutas = $conexion->query($sqls);
      $ruta3 = $conexion->query($sql3);
      if ($ruta = $conexion->query($sql)) {
      ...
      $sql = 'UPDATE campana SET bolsa_ampi="'.$bolsa_ampi.'",bolsa_fecha="'.$bolsa_fecha.'",portal_crm="'.$portal_crm.'",portal_fecha="'.$portal_fecha.'",portal_crm="'.$portal_crm.'",portal_fecha="'.$portal_fecha.'",revista="'.$revista.'",revista_fecha="'.$revista_fecha.'",venta_brokers="'.$venta_brokers.'",venta_fecha="'.$venta_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sqls = 'UPDATE campana SET otros="'.$otros.'",periodico="'.$periodico.'",periodico_fecha="'.$periodico_fecha.'",web="'.$web.'",web_fecha="'.$web_fecha.'",letrero="'.$letrero.'",letrero_fecha="'.$letrero_fecha.'",redes_sociales="'.$redes_sociales.'",redes_fecha="'.$redes_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sql3 = 'UPDATE campana SET bolsa_btn="'.$bolsa_btn.'",portal_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $rutas = $conexion->query($sqls);
      $ruta3 = $conexion->query($sql3);
      if ($ruta = $conexion->query($sql)) {
      ...
      $sqls = 'UPDATE campana SET otros="'.$otros.'",web="'.$web.'",web_fecha="'.$web_fecha.'",letrero="'.$letrero.'",letrero_fecha="'.$letrero_fecha.'",redes_sociales="'.$redes_sociales.'",redes_fecha="'.$redes_fecha.'",evento_open_house="'.$evento_open_house.'",evento_fecha="'.$evento_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sql3 = 'UPDATE campana SET bolsa_btn="'.$bolsa_btn.'",portal_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="3" ';
      $sqlproceso = 'UPDATE proceso_cartera SET id_proceso="10.1",fecha_inicio="'.$fecha_inicio.'",fecha_entrega="'.$fecha_entrega.'" WHERE id_cartera="'.$id_cartera.'" ';
