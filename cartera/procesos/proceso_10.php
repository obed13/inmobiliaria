<?php  
	...
	$sqlcampana = "SELECT * FROM campana a WHERE id_cartera='$id' AND campana='3' ";
...
<div class="col-xs-12 col-md-9">
	...
	<br>
	<form action="procesos/save_proceso_10.php" method="POST" name="formulario" role="form">
		<table border="0" class="table table-striped">
			<tr>
				<td><label for="publicitar_inicio">Publicitar (Campaña Final)</label></td>
