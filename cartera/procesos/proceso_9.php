...
<?php while ($campana = $result->fetch_array()) { ?>
			...
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="venta_brokers_btn" <?php if ($campana['venta_brokers_btn'] == 1) {?> checked="checked" <?php } ?> id="venta_brokers_btn" value="1" onclick="document.formulario.venta_brokers_fecha.disabled=!document.formulario.venta_brokers_fecha.disabled" ></td>
