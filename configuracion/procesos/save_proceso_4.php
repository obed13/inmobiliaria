...
//echo $_FILES['archivo']['name'].' '.$_FILES['archivo']['tmp_name'];
    if (move_uploaded_file($_FILES['archivo']['tmp_name'], '../../'.$destino)) {
     ...
     #Funcion de Mensaje para El Encargado del Proceso
      ...
      #Fin de Funcion
      $sql = 'UPDATE proceso_cartera SET id_proceso="5",archivo="'.$destino.'", precio_dueno="'.$precio_dueno.'",precio_sugerido="'.$precio_sugerido.'",fecha_inicio="'.$fecha_inicio.'",fecha_entrega="'.$fecha_entrega.'" WHERE id_cartera="'.$id_cartera.'" ';
