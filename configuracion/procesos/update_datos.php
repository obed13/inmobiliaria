<?php  
	require_once '../../conexion.php';
  	...
  	if ($precio == 'si' && $contrato == 'no') {
  		$sql = "UPDATE proceso_cartera SET nuevo_precio='".$precio."', precio_dueno='".$new_cash."' WHERE id_cartera='".$id."' ";
  		...
  		$sql = "UPDATE proceso_cartera SET nuevo_precio='".$precio."', precio_dueno='".$new_cash."', nuevo_contrato='".$contrato."', nueva_fecha='".$new_contrato."' WHERE id_cartera='".$id."' ";
  	}
