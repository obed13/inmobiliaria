...
//=====================================================================================================================//
    if ($bolsa_ampi == '') {
      $sql = 'UPDATE campana SET bolsa_fecha="'.$bolsa_fecha.'",portal_crm="'.$portal_crm.'",portal_fecha="'.$portal_fecha.'",revista="'.$revista.'",revista_fecha="'.$revista_fecha.'",venta_brokers="'.$venta_brokers.'",venta_fecha="'.$venta_fecha.'",periodico="'.$periodico.'",periodico_fecha="'.$periodico_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $sqls = 'UPDATE campana SET otros="'.$otros.'",web="'.$web.'",web_fecha="'.$web_fecha.'",letrero="'.$letrero.'",letrero_fecha="'.$letrero_fecha.'",redes_sociales="'.$redes_sociales.'",redes_fecha="'.$redes_fecha.'",evento_open_house="'.$evento_open_house.'",evento_fecha="'.$evento_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $sql3 = 'UPDATE campana SET portal_crm_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $rutas = $conexion->query($sqls);
      $ruta3 = $conexion->query($sql3);
      if ($ruta = $conexion->query($sql)) {
        header("Location:../proceso.php?id=$id_cartera&proceso=8");
      } else {
        header("Location:../proceso.php?id=$id_cartera&proceso=8&msj=1");
      }
    } elseif ($portal_crm == '') {
      ...
      $sqls = 'UPDATE campana SET otros="'.$otros.'",periodico="'.$periodico.'",periodico_fecha="'.$periodico_fecha.'",letrero="'.$letrero.'",letrero_fecha="'.$letrero_fecha.'",redes_sociales="'.$redes_sociales.'",redes_fecha="'.$redes_fecha.'",evento_open_house="'.$evento_open_house.'",evento_fecha="'.$evento_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $sql3 = 'UPDATE campana SET portal_crm_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $rutas = $conexion->query($sqls);
      $ruta3 = $conexion->query($sql3);
      if ($ruta = $conexion->query($sql)) {
      ...
      $sqls = 'UPDATE campana SET otros="'.$otros.'",periodico="'.$periodico.'",periodico_fecha="'.$periodico_fecha.'",web="'.$web.'",web_fecha="'.$web_fecha.'",redes_sociales="'.$redes_sociales.'",redes_fecha="'.$redes_fecha.'",evento_open_house="'.$evento_open_house.'",evento_fecha="'.$evento_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $sql3 = 'UPDATE campana SET portal_crm_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $rutas = $conexion->query($sqls);
      $ruta3 = $conexion->query($sql3);
      if ($ruta = $conexion->query($sql)) {
      ...
      $sqls = 'UPDATE campana SET otros="'.$otros.'",periodico="'.$periodico.'",periodico_fecha="'.$periodico_fecha.'",web="'.$web.'",web_fecha="'.$web_fecha.'",letrero="'.$letrero.'",letrero_fecha="'.$letrero_fecha.'",evento_open_house="'.$evento_open_house.'",evento_fecha="'.$evento_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $sql3 = 'UPDATE campana SET portal_crm_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $rutas = $conexion->query($sqls);
      $ruta3 = $conexion->query($sql3);
      if ($ruta = $conexion->query($sql)) {
      ...
      $sqls = 'UPDATE campana SET otros="'.$otros.'",periodico="'.$periodico.'",periodico_fecha="'.$periodico_fecha.'",web="'.$web.'",web_fecha="'.$web_fecha.'",letrero="'.$letrero.'",letrero_fecha="'.$letrero_fecha.'",redes_sociales="'.$redes_sociales.'",redes_fecha="'.$redes_fecha.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $sql3 = 'UPDATE campana SET portal_crm_btn="'.$portal_crm_btn.'",revista_btn="'.$revista_btn.'",venta_btn="'.$venta_btn.'",periodico_btn="'.$periodico_btn.'",web_btn="'.$web_btn.'",letrero_btn="'.$letrero_btn.'",redes_btn="'.$redes_btn.'",evento_btn="'.$evento_btn.'" WHERE id_cartera="'.$id_cartera.'" AND campana="1" ';
      $rutas = $conexion->query($sqls);
      $ruta3 = $conexion->query($sql3);
      if ($ruta = $conexion->query($sql)) {
