<?php
	...
	$sqlcampana = "SELECT * FROM campana a WHERE id_cartera='$id' AND campana='2' ";
...
<div class="col-xs-12 col-md-9">
	...
	<br>
	<form action="procesos/save_proceso_9.php" method="POST" name="formulario" role="form">
		<table border="0" class="table table-striped">
			<tr>
				<td><label for="publicitar_inicio">Publicitar (Campaña Intermedia)</label></td>
...
<?php while ($campana = $result->fetch_array()) { ?>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="bolsa_ampi_btn" <?php if ($campana['bolsa_btn'] == 1) {?> checked="checked" <?php } ?> id="bolsa_ampi_btn" value="1" onclick="document.formulario.bolsa_ampi_fecha.readOnly=!document.formulario.bolsa_ampi_fecha.readOnly" ></td>
				<td><input type="date" class="form-control" name="bolsa_ampi_fecha" value="<?php echo $campana['bolsa_fecha']; ?>" id="bolsa_ampi_fecha" readonly /></td>
			</tr>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="portal_crm_btn" <?php if ($campana['portal_btn'] == 1) {?> checked="checked" <?php } ?> id="portal_crm_btn" value="1" onclick="document.formulario.portal_crm_fecha.readOnly=!document.formulario.portal_crm_fecha.readOnly" ></td>
				<td><input type="date" class="form-control" name="portal_crm_fecha" value="<?php echo $campana['portal_fecha']; ?>" id="portal_crm_fecha" readonly /></td>
			</tr>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="revista_btn" <?php if ($campana['revista_btn'] == 1) {?> checked="checked" <?php } ?> id="revista_btn" value="1" onclick="document.formulario.revista_fecha.readOnly=!document.formulario.revista_fecha.readOnly" ></td>
				<td><input type="date" class="form-control" name="revista_fecha" value="<?php echo $campana['revista_fecha']; ?>" id="revista_fecha" readonly /></td>
			</tr>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="venta_brokers_btn" <?php if ($campana['venta_brokers_btn'] == 1) {?> checked="checked" <?php } ?> id="venta_brokers_btn" value="1" onclick="document.formulario.venta_brokers_fecha.readOnly=!document.formulario.venta_brokers_fecha.readOnly" ></td>
				<td><input type="date" class="form-control" name="venta_brokers_fecha" value="<?php echo $campana['venta_fecha']; ?>" id="venta_brokers_fecha" readonly /></td>
			</tr>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="periodico_btn" <?php if ($campana['periodico_btn'] == 1) {?> checked="checked" <?php } ?> id="periodico_btn" value="1" onclick="document.formulario.periodico_fecha.readOnly=!document.formulario.periodico_fecha.readOnly" ></td>
				<td><input type="date" class="form-control" name="periodico_fecha" value="<?php echo $campana['periodico_fecha']; ?>" id="periodico_fecha" readonly /></td>
			</tr>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="web_btn" <?php if ($campana['web_btn'] == 1) {?> checked="checked" <?php } ?> id="web_btn" value="1" onclick="document.formulario.web_fecha.readOnly=!document.formulario.web_fecha.readOnly" ></td>
				<td><input type="date" class="form-control" name="web_fecha" value="<?php echo $campana['web_fecha']; ?>" id="web_fecha" readonly /></td>
			</tr>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="letrero_btn" <?php if ($campana['letrero_btn'] == 1) {?> checked="checked" <?php } ?> id="letrero_btn" value="1" onclick="document.formulario.letrero_fecha.readOnly=!document.formulario.letrero_fecha.readOnly" ></td>
				<td><input type="date" class="form-control" name="letrero_fecha" value="<?php echo $campana['letrero_fecha']; ?>" id="letrero_fecha" readonly /></td>
			</tr>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="redes_sociales_btn" <?php if ($campana['redes_btn'] == 1) {?> checked="checked" <?php } ?> id="redes_sociales_btn" value="1" onclick="document.formulario.redes_sociales_fecha.readOnly=!document.formulario.redes_sociales_fecha.readOnly" ></td>
				<td><input type="date" class="form-control" name="redes_sociales_fecha" value="<?php echo $campana['redes_fecha']; ?>" id="redes_sociales_fecha" readonly /></td>
			</tr>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="evento_open_house_btn" <?php if ($campana['evento_btn'] == 1) {?> checked="checked" <?php } ?> id="evento_open_house_btn" value="1" onclick="document.formulario.evento_open_house_fecha.readOnly=!document.formulario.evento_open_house_fecha.readOnly" ></td>
				<td><input type="date" class="form-control" name="evento_open_house_fecha" value="<?php echo $campana['evento_fecha']; ?>" id="evento_open_house_fecha" readonly /></td>
			</tr>
			<tr>
