<?php
	$sql = "SELECT a.* FROM proceso_cartera a WHERE id_cartera='$id' ";
...
<div class="col-xs-12 col-md-4">
	<form action="procesos/save_proceso_2.php" method="POST">
		...
		<br>
		<textarea class="form-control"  name="comment_seguimiento" id="comment_seguimiento" cols="50" rows="5" ><?php echo $row['comment_seguimiento']; ?></textarea>
