...
<?php while ($campana = $result->fetch_array()) { ?>
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="bolsa_ampi_btn" <?php if ($campana['bolsa_btn'] == 1) {?> checked="checked" <?php } ?> id="bolsa_ampi_btn" value="1" onclick="document.getElementById('bolsa_ampi_fecha').readOnly=!document.getElementById('bolsa_ampi_fecha').readOnly" ></td>
			...
			<tr>
				...
				<td><input type="checkbox" <?php if($proceso == false) { ?> disabled <?php } ?> name="venta_brokers_btn" <?php if ($campana['venta_btn'] == 1) {?> checked="checked" <?php } ?> id="venta_brokers_btn" value="1" onclick="document.formulario.venta_brokers_fecha.readOnly=!document.formulario.venta_brokers_fecha.readOnly" ></td>
			...
			<tr>
				...
				<td colspan="4"><textarea name="otros" <?php if($proceso == false) { ?> disabled <?php } ?> id="otros" cols="60" rows="5"><?php echo $campana['otros']; ?></textarea></td>
			</tr>
<?php } ?>
			<tr>
				<td colspan="5">
