        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          ?>
                <tr>
                  ...
                  <td><a href="editCartera.php?id=<?php echo $row['id_cartera']; ?>" class="btn btn-info">Editar</a></td>
                  <td><a href="deteleCartera.php?id=<?php echo $row['id_cartera']; ?>" class="btn btn-danger">Eliminar</a> </td>
                </tr>
          <?php } ?>
              </tbody>
            </table>
